<template>
    ...
    <div class="pt-10 px-10 main grid place-items-start h-screen ">
        ...
        <div class="flex flex-col bg-white rounded-lg filter drop-shadow-md h-104 w-10/12 md:w-100"> 
            ...
            <form ref="editForm" class="flex flex-col justify-center items-center w-full" @submit.prevent="editUser()">
                ...
                <button class="block rounded-md bg-secondary hover:bg-yellow-500 transition ease-linear text-white font-semibold w-10/12 text-lg m-3 h-10" type="button" @click="editUser" data-modal-toggle="popup-modal">Edit</button>
            </form>
        </div>
    <!-- </div> -->
</div>
