<template>
    ...
    <div class="pt-32 px-10 main grid place-items-start h-screen ">
        ...
        <div class="card bg-white flex flex-col items-center justify-center p-4 shadow-lg rounded-2xl w-full">
            ...
            <div id="authentication-modal"  class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center h-modal md:h-full md:inset-0">
            ...
            <button type="update" class="w-full text-white bg-secondary hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update</button>
            </form>
</div>
</div>
</div>
            ...
            <div class="container mx-auto">
                ...
                <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
                    ...
                    <div class="p-4 flex items-center text-sm text-gray-600">
                        ...
                        </svg><span class="ml-2">34 Bewertungen</span>
                    </div>
                </a>
                </div>
                <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
