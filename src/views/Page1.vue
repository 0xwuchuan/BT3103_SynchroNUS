<template>
  ...
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Gym Session@UHC">
...
<link rel="stylesheet" href="Page-1.css" media="screen">
  ...
  <body class="u-body u-xl-mode">
	...
	c-0.252,0.137-0.502,0.297-0.752,0.476C5.276,41.792,2,35.022,2,27.5z"></path></svg></span>
                  <p class="u-text u-text-1">Joined by 3 users</p>
                  <h2 class="u-align-center u-text u-text-default u-text-2">Gym Session@UHC</h2>
...
<style scoped>
 .u-section-1 {
  background-image: linear-gradient(to left, #ff7e5b, #478ac9);
}
