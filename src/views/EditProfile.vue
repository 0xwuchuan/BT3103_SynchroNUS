<template>
    <Nav />   
    <div class="flex justify-center flex-row h-5/6 ml-10 p-5">
        <div class="flex justify-center flex-col bg-white opacity-90 rounded-lg filter drop-shadow-md h-108 w-10/12 md:w-104 p-5">
            ...
            <h3 class="text-3xl text-center font-semibold pl-3">Edit your Profile</h3>
